...
fun LearningHomeScreen(
    ...
    var currentSection by remember { mutableStateOf(LearningSection.Interop) }
    ...
    Column(
        ...
        when (currentSection) {
            LearningSection.Basics -> BasicsLearningScreen()
            LearningSection.Practice -> PracticeLearningScreen()
